(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_d4f2ac0e._.js", {
...
function LeaderboardPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LeaderboardPage.useEffect": ()=>{
            ...
            if (period === 'weekly') {
                const cutoff = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$subDays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subDays"])(now, 7);
                filtered = entries.filter({
                    "LeaderboardPage.useEffect": (e)=>new Date(e.date) >= cutoff
                }["LeaderboardPage.useEffect"]);
            } else if (period === 'monthly') {
                const cutoff = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$subMonths$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subMonths"])(now, 1);
                filtered = entries.filter({
                    "LeaderboardPage.useEffect": (e)=>new Date(e.date) >= cutoff
                }["LeaderboardPage.useEffect"]);
            }
            ...
            const tally = {};
            filtered.forEach({
                "LeaderboardPage.useEffect": (e)=>{
                    tally[e.email] = (tally[e.email] || 0) + e.points;
                }
            }["LeaderboardPage.useEffect"]);
            // Convertir a array y ordenar de mayor a menor
            const list = Object.entries(tally).map({
                "LeaderboardPage.useEffect.list": ([email, total])=>({
                        email,
                        total
                    })
            }["LeaderboardPage.useEffect.list"]).sort({
                "LeaderboardPage.useEffect.list": (a, b)=>b.total - a.total
            }["LeaderboardPage.useEffect.list"]);
            setScores(list);
        }
    }["LeaderboardPage.useEffect"], [
        entries,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                        children: scores.length > 0 ? scores.map((s, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                children: [
...
//# sourceMappingURL=_d4f2ac0e._.js.map